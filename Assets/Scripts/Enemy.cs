...
public class Enemy : MonoBehaviour
{
    ...
    void Patrol()
    {
        ...
        {
            animator.SetBool("esta_andando", true);
    ...
    IEnumerator Respawn()
    {
        ...
        newMonster.GetComponent<Enemy>().entity.dead = false;
    ...
    public void ToBleed()
    {
        ...
        Instantiate(blood, position, transform.rotation, null);

        //yield return new WaitForSeconds(5f);

        //Destroy(newBlood.gameObject);
